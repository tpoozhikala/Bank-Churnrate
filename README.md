...
<span style="font-size:1.5em; font-weight:bold;">Goal:</span> Develop a robust AI-powered early warning system to predict extreme region-specific weather conditions, specifically floods, heavy rains, and heat waves with at least 80% prediction accuracy.
