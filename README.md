...
Goal: Develop a robust AI-powered early warning system to predict extreme regions specific weather conditions, specifically floods, heavy rains, and heat waves with at least 80% prediction accuracy.
